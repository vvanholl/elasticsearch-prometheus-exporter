...
- Since Elasticsearch 6.0.0 :
    `./bin/elasticsearch-plugin install -b https://github.com/vvanholl/elasticsearch-prometheus-exporter/releases/download/6.8.6.0/prometheus-exporter-6.8.6.0.zip`
